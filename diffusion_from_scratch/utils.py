...
def get_synthetic(img_size=64):
    """
    These directories are structured like this:
    64x64
        train
            male_nurse
                xyz.png
    ...
    """
    if img_size == 64:
        return Path("/n/holylabs/LABS/sneel_lab/Lab/jgwang/diffusion_synthetic_data/Images/64x64")
    elif img_size == 128:
        return Path("/n/holylabs/LABS/sneel_lab/Lab/jgwang/diffusion_synthetic_data/Images/128x128")
    else:
        return Path("/n/holylabs/LABS/sneel_lab/Lab/jgwang/diffusion_synthetic_data/Images/FullSize")
...
def get_data(args):
    """
    Note that this method will make dataloaders from the directory structure given! 
    """
...
def load_w2v_embedding():
    from gensim.models.keyedvectors import KeyedVectors
    from gensim.downloader import load

    w2vectors = load("word2vec-google-news-300")
    return w2vectors
